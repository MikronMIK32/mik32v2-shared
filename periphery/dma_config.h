...
#define DMA_CH_CFG_READ_REQUESTS_S               17    // выбор канала чтения 
#define DMA_CH_CFG_READ_REQUESTS_M               (0xF << DMA_CH_CFG_READ_REQUESTS_S)
#define DMA_CH_CFG_READ_REQUESTS(v)              (((v) << DMA_CH_CFG_READ_REQUESTS_S) & DMA_CH_CFG_READ_REQUESTS_M)

#define DMA_CH_CFG_WRITE_REQUESTS_S              21    // выбор канала записи 
#define DMA_CH_CFG_WRITE_REQUESTS_M              (0xF << DMA_CH_CFG_WRITE_REQUESTS_S)
#define DMA_CH_CFG_WRITE_REQUESTS(v)             (((v) << DMA_CH_CFG_WRITE_REQUESTS_S) & DMA_CH_CFG_WRITE_REQUESTS_M)
