...
#define SPIFI_CONFIG_CMD_DATALEN_BUSY_INDEX_M		      (0b111 << SPIFI_CONFIG_CMD_DATALEN_BUSY_INDEX_S) 
#define SPIFI_CONFIG_CMD_DATALEN_BUSY_INDEX(v)			  (((v) << SPIFI_CONFIG_CMD_DATALEN_BUSY_INDEX_S) & SPIFI_CONFIG_CMD_DATALEN_BUSY_INDEX_M)
#define SPIFI_CONFIG_CMD_DATALEN_BUSY_DONE_VALUE_S	  3 
#define SPIFI_CONFIG_CMD_DATALEN_BUSY_DONE_VALUE_M	  (1 << SPIFI_CONFIG_CMD_DATALEN_BUSY_DONE_VALUE_S) 
